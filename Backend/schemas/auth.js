...
const passwordSchema = z.object({
  ...
  { message: "La nueva contraseña debe contener al menos una mayúscula y un número", path: ["passwordNueva"] }
);

module.exports = { registroSchema, loginSchema, actualizarPerfilSchema, passwordSchema };