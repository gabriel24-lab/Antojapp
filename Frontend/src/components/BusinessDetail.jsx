    ...
    <div style={{ maxWidth: 820, margin: "0 auto", padding: "16px var(--content-px, 16px) 80px" }}>
      ...
      <div style={{ position: "relative", height: "clamp(200px, 40vw, 280px)", borderRadius: 14, overflow: "hidden", marginBottom: 24 }}>
        ...
        <div style={{ position: "absolute", bottom: 20, left: 24, right: 24 }}>
          <h1 style={{ fontFamily: "'Manrope', sans-serif", fontWeight: 800, fontSize: "clamp(22px, 5vw, 30px)", color: "var(--surface)", marginBottom: 8, lineHeight: 1.1 }}>
            {negocio.nombre}
          </h1>
        ...
        <button
          ...
          style={{
            ...
            background: favorito ? "var(--brand)" : "rgba(255,255,255,.9)",
      ...
      <div className="detail-2col" style={{ marginBottom: 20 }}>
        ...
        <div className="card" style={{ padding: "18px 20px", gridColumn: "1 / -1" }}>
          ...
          <div style={{ marginTop: 14, display: "flex", gap: 6, flexWrap: "wrap" }}>
            {negocio.etiquetas.map(tag => (
              <span key={tag} style={{ fontSize: 12, padding: "3px 10px", borderRadius: 20, background: "var(--bg)", color: "var(--text-2)", border: "1px solid var(--border)" }}>#{tag}</span>
            ))}
          </div>
        </div>
        ...
        {[
          ...
          <div key={label} className="card" style={{ padding: "14px 16px", background: bg, border: `1px solid ${color}22` }}>
            ...
            <div style={{ fontSize: 14, fontWeight: 600, color: "var(--text-1)", marginBottom: 3 }}>{plato.nombre}</div>
              ...
              {negocio.sedes.map((s, i) => (
                <button
                  ...
                  style={{
                    ...
                    background: sedeActiva === i ? "var(--brand)" : "var(--bg)",
                    color:      sedeActiva === i ? "#fff"    : "var(--text-2)",
                    border:     sedeActiva === i ? "none"    : "1px solid var(--border)",
        ...
        <div className="sede-grid">
          ...
          <div style={{ padding: "16px 20px" }}>
            ...
            {(sede.telefonos?.length > 0) && (
              <div style={{ marginBottom: 12 }}>
                <div style={{ fontSize: 12, color: "var(--text-3)", fontWeight: 500, marginBottom: 6 }}>CONTACTO</div>
                    ...
                    return (
                      <a
                        ...
                        style={{
                          ...
                          textDecoration: "none",
                          background: "var(--green-bg)", padding: "6px 12px",
                          borderRadius: 8, width: "fit-content",
                          border: "1px solid #B7DFC9", /* borde hover WhatsApp — verde suave */
            ...
            <div>
              <div style={{ fontSize: 12, color: "var(--text-3)", fontWeight: 500, marginBottom: 6 }}>HORARIO</div>
                ...
                {DIAS.map((dia, i) => {
                  ...
                  return (
                    <div key={dia} style={{
                      ...
                      fontSize: 13,
                      background: esHoy ? "var(--brand-light)" : "transparent",
                      padding: esHoy ? "3px 6px" : "1px 0",
                      borderRadius: 4, fontWeight: esHoy ? 600 : 400
                    }}>
                      <span style={{ color: esHoy ? "var(--brand)" : "var(--text-2)" }}>{DIAS_ES[i]}</span>
                      <span style={{ color: horaDia === "cerrado" ? "var(--text-3)" : "var(--text-1)" }}>
          ...
          {/* Mapa */}
          <div style={{ background: "var(--bg2)", position: "relative", minHeight: 220 }}>
            <iframe
      ...
      <div className="card" style={{ padding: "20px" }}>
        ...
        <form onSubmit={enviarResena} style={{
          ...
          />
          {enviadoResena && (
            <div style={{ fontSize: 13, color: "var(--green)", marginBottom: 8, display: "flex", alignItems: "center", gap: 5 }}>
              <AppIcon name="check" size={15} /> Reseña publicada, ¡gracias!
            </div>
          )}
          {errorResena && (
            <div style={{ fontSize: 13, color: "var(--red)", background: "var(--red-bg)", padding: "8px 12px", borderRadius: 8, marginBottom: 8 }}>{errorResena}</div>
          )}
          <button
          ...
          {resenas.map(r => (
            <div key={r.id} style={{ borderBottom: "1px solid #F0EBE5", paddingBottom: 14 }}>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 5 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <div style={{
                    ...
                    display: "flex", alignItems: "center", justifyContent: "center",
                    fontSize: 13, fontWeight: 700, color: "var(--surface)"
                  }}>
              ...
              <div style={{ marginLeft: 38 }}>
                ...
                <p style={{ fontSize: 14, color: "var(--text-2)", marginTop: 4, lineHeight: 1.55 }}>{r.comentario}</p>
              </div>
            </div>
          ))}
        </div>
