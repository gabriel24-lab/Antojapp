...
export default function Navbar({
  ...
  const { pais, departamento, ciudad, cambiarUbicacion } =
    useUbicacionContext();
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <button
              style={navLinkStyle(vistaActual === "home")}
              onClick={onIrInicio}
            >
              Inicio
            </button>
            <button
              style={navLinkStyle(vistaActual === "negocios")}
          ...
          <div
            ...
            className={`nav-search${busquedaMovil ? " nav-search--open" : ""}`}
          >
            <span
              style={{
                position: "absolute",
            ...
            <input
              ...
              onFocus={() => {
                if (vistaActual !== "home" && vistaActual !== "negocios")
                  onIrInicio();
              }}
              style={{
                width: "100%",
                height: compacto ? 34 : 38,
              ...
              onBlur={(e) => {
                e.target.style.borderColor = "rgba(255,255,255,.13)";
              }}
            />
            {busqueda && (
              <button
          ...
          >
            {user && !esPropietario && (
              <button
                ...
                style={{
                  ...navLinkStyle(vistaActual === "favoritos"),
                  display: "flex",
                  alignItems: "center",
                  gap: 5,
                }}
            ...
            {esPropietario && (
              <button
                ...
                style={{
                  ...navLinkStyle(vistaActual === "panel"),
                  display: "flex",
                  alignItems: "center",
                  gap: 5,
                }}
          ...
          {user && (
            <div
              className="nav-avatar-mobile-group"
              style={{
                display: "none",
                alignItems: "center",
                gap: 6,
        ...
        <div
          className={`mobile-search-bar${busquedaMovil ? " mobile-search-bar--open" : ""}`}
          style={{
      ...
      {menuMovil && (
        <>
          ...
          >
            ...
            {/* Navegación */}
            <div
              style={{ padding: "10px 8px", borderBottom: "1px solid #F0EBE5" }}
            >
              <MobileNavBtn
                icon="home"
                activo={vistaActual === "home"}
                onClick={() => {
                  onIrInicio();
                  setMenuMovil(false);
                }}
        ...
        >
          <div
            ...
            style={{
              ...
              overflow: "hidden",
              animation: "logoutIn .22s cubic-bezier(.34,1.56,.64,1)",
            }}
          >
            <div
              style={{
            ...
            >
              <div
                style={{
                  ...
                  height: 56,
                  borderRadius: "50%",
                  background: "rgba(232,70,10,.15)",
                  border: "2px solid rgba(232,70,10,.3)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  margin: "0 auto 12px",
...
function UserMenuContent({
  ...
  return (
    <>
      ...
      <MenuBtn onClick={onPerfil} icon="user">
        Mi perfil
      </MenuBtn>
      {esPropietario && (
        <>
          <MenuBtn onClick={onPanel} icon="barChart">
            Mi panel
          </MenuBtn>
          <MenuBtn
            onClick={onAgregar}
      ...
      {!esPropietario && (
        <MenuBtn onClick={onFavoritos} icon="heart">
          Mis guardados
        </MenuBtn>
      )}
      <MenuBtn onClick={onLogout} danger>
        Cerrar sesión
      </MenuBtn>
    </>
  );
  ...
  return (
    <button
      ...
      style={{
        ...
        background:
          hover && !disabled ? (danger ? "#FFF0EE" : "var(--bg)") : "none",
        border: "none",
        borderTop: danger ? "1px solid #F0EBE5" : "none",
