...
export const LOCATION_DATA = [
  {
    ...
    departamentos: [
      {
        nombre: "Cesar",
        ciudades: ["Valledupar", "Aguachica", "Codazzi", "La Jagua de Ibirico"],
      },
      { nombre: "Bogotá D.C.", ciudades: ["Bogotá"] },
      {
        nombre: "Antioquia",
        ciudades: ["Medellín", "Bello", "Itagüí", "Envigado", "Sabaneta"],
      },
      {
        nombre: "Bolívar",
        ciudades: ["Cartagena", "Magangué", "El Carmen de Bolívar"],
      },
      {
        nombre: "Valle del Cauca",
        ciudades: ["Cali", "Buenaventura", "Palmira", "Tuluá"],
      },
      { nombre: "Atlántico", ciudades: ["Barranquilla", "Soledad", "Malambo"] },
      {
        nombre: "Santander",
        ciudades: ["Bucaramanga", "Floridablanca", "Girón", "Barrancabermeja"],
      },
      {
        nombre: "Cundinamarca",
        ciudades: ["Soacha", "Facatativá", "Zipaquirá", "Chía"],
      },
  ...
  },
  {
    ...
    departamentos: [
      ...
      {
        nombre: "Nuevo León",
        ciudades: ["Monterrey", "San Nicolás", "Guadalupe", "Apodaca"],
      },
  ...
  },
  {
    ...
    departamentos: [
      {
        nombre: "Lima",
        ciudades: ["Lima", "Miraflores", "San Isidro", "Barranco"],
      },
      {
        nombre: "Cusco",
        ciudades: ["Cusco", "Pisac", "Ollantaytambo", "Aguas Calientes"],
      },
    ...
    departamentos: [
      {
        ...
        ciudades: ["Madrid", "Alcalá de Henares", "Getafe", "Leganés"],
      },
      {
        nombre: "Cataluña",
        ciudades: ["Barcelona", "Girona", "Tarragona", "Lleida"],
      },
      {
        nombre: "Andalucía",
        ciudades: ["Sevilla", "Málaga", "Granada", "Córdoba"],
      },
      {
  ...
  },
  {
    ...
    departamentos: [
      {
        nombre: "Tokio",
        ciudades: ["Tokio", "Shinjuku", "Shibuya", "Akihabara"],
      },
  ...
  },
  {
    ...
    departamentos: [
      ...
      {
        nombre: "Lombardía",
        ciudades: ["Milán", "Bérgamo", "Brescia", "Como"],
      },
      {
        nombre: "Toscana",
        ciudades: ["Florencia", "Siena", "Pisa", "Livorno"],
      },
      {
        nombre: "Campania",
        ciudades: ["Nápoles", "Pompeya", "Salerno", "Amalfi"],
      },
    ],
  },
  {
    ...
    departamentos: [
      {
        nombre: "New York",
        ciudades: ["Nueva York", "Buffalo", "Rochester", "Syracuse"],
      },
      {
        nombre: "California",
        ciudades: ["Los Ángeles", "San Francisco", "San Diego", "Sacramento"],
      },
      {
        nombre: "Illinois",
        ciudades: ["Chicago", "Aurora", "Naperville", "Joliet"],
      },
      {
        nombre: "Florida",
...
export function getDepartamentoDeCiudad(codigoPais, ciudad) {
  ...
  if (!pais) return null;
  return (
    pais.departamentos.find((d) => d.ciudades.includes(ciudad))?.nombre || null
  );
}
