  ...
  useEffect(() => {
    ...
    if (window.google?.accounts?.id) {
      ...
      if (!document.getElementById("gis-script")) {
        ...
        document
          .getElementById("gis-script")
          .addEventListener("load", cargarGIS, { once: true });
      }
    }
  }, [vista, loginExito]);
  ...
  const handleConfirmarRolGoogle = async (rolElegido) => {
    ...
    try {
      const res = await fetch(`${API_URL}/auth/google`, {
        ...
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          credential: pendienteGoogle.credential,
          rol: rolElegido,
        }),
        credentials: "include",
      });
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        setError(
          data.error ||
            "Tuvimos un problema al iniciar sesión. Verifica tus datos e intenta nuevamente.",
        );
        return;
      }
      login(data.token, data.usuario);
  ...
  const opcionesRol = [
    {
      ...
      icon: "utensils",
      titulo: "Soy cliente",
      sub: "Busco dónde comer",
    },
    {
      valor: "negocio",
      icon: "store",
      titulo: "Soy propietario",
      sub: "Registro mi negocio",
    },
  ];
          ...
          >
              ...
              <div style={{ textAlign: "center", padding: "20px 0" }}>
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    background:
                      "linear-gradient(135deg, var(--green), #22B573)",
                    margin: "0 auto 18px",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
            ...
            {!loginExito && pendienteGoogle && (
              <div>
                ...
                >
                  Hola {pendienteGoogle.nombre?.split(" ")[0]}, ¿cómo usarás
                  Antojapp?
                </p>
                <div
                  style={{
              ...
              <>
                ...
                <div style={{ marginBottom: 28 }}>
                  ...
                  <p style={{ fontSize: 14, color: "var(--text-3)" }}>
                    {vista === "login" &&
                      "Inicia sesión para guardar tus antojos"}
                    {vista === "registro" &&
                  ...
                  <>
                    ...
                    {!import.meta.env.VITE_GOOGLE_CLIENT_ID && (
                      ...
                      >
                        ...
                        agrega <code>VITE_GOOGLE_CLIENT_ID</code> en{" "}
                        <code>.env</code>
                      </div>
                    )}
                    <Divider />
                ...
                {vista === "recuperar" && (
                  ...
                  >
                    {exito ? (
                      ...
                      >
                        <div
                          style={{ marginBottom: 10, color: "var(--green)" }}
                        >
                    ...
                    <div style={{ textAlign: "center" }}>
                      <button
                        ...
                        style={{ fontSize: 13 }}
                      >
                        <AppIcon name="arrowLeft" size={14} /> Volver al inicio
                        de sesión
                      </button>
                    </div>
                  </form>
