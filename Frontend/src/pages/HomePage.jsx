...
export default function HomePage({ onVerDetalle, onAbrirAuth, busqueda, onBusqueda, modoNegocios }) {
  ...
  // Si viene en modo "Negocios", hacer scroll directo a resultados
  useEffect(() => {
  ...
  // Cargar negocios cuando cambian los filtros
  ...
  return (
    <div>
      {/* ── Hero — se oculta en modo Negocios ── */}
      {!modoNegocios && (
      ...
      {/* ── Filtros sticky ── */}
      <section style={{
        background: "#fff", borderBottom: "1px solid #E2DBD5",
        ...
        {!cargando && !error && negocios.length === 0 && (
          <div style={{ textAlign: "center", padding: "60px 20px", color: "#A8988A" }}>
            ...
            <button
              ...
              onClick={() => { onBusqueda(""); setCategoria("Todas"); }}
              style={{ marginTop: 20 }}
            >
